...
#' - \eqn{X_i ~ i.i.d N(0, 1)}
#' - \eqn{M_{i,v} = a_v X_i + e{1_{i,v}}}, where \eqn{e{1_{i,v}} ~ i.i.d N(0, 1), v = 1, ..., V}
#' - \eqn{Y_i = X_i + sum_v b{1_{i,v}} M_{i,v} + sum_v b{2_{i,v}} X_i x M_{i,v} + e{2_{i,v}}}, where \eqn{e{2_{i,v}} ~ i.i.d. N(0, 1)}
